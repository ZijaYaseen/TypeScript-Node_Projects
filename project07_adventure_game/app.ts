...
class Game{
    static enimies :string[]=["Skeleton", "Zoombie", "Warrior", "Assassian"]

    //game variables:
    static maxEnemyHealth :number= 75;
    static enemyAttackDamage :number = 25;

    //player variables:
    static playerHealth:number=100;
    static playerAttackDamage:number=30;
    static numHealthPotions:number=3;
    static healthPotionHealAmount:number=40;
}
